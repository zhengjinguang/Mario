 ...
 * {@link com.android.volley.toolbox.ImageLoader#getImageListener(ImageView, int, int)}. Note that
...
public class ImageLoader {
   ...
   * If the default was returned, the {@link com.android.volley.toolbox.ImageLoader} will be invoked
   * when the
