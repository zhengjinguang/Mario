 ...
 * USA.
 * <p>
 * This class generates a stream of random data and compares the results of the md5 checksum
 * generated by an instance of MD5OutputStream with the md5 checksum by piping the data through the
 * local 'md5sum' or 'md5' binary.
 * <p>
...
public class MD5OutputStreamTest {
  ...
  private static long outputFullBuffer(Random ran, OutputStream out1, OutputStream out2,
      long max_bytes) throws IOException {
  ...
  private static long outputPartialBuffer(Random ran, OutputStream out1, OutputStream out2,
      long max_bytes) throws IOException {
    int b_len = ran.nextInt();
    if (b_len < 0) b_len = -b_len;
