 ...
 */
public class MountActivity extends BaseFragmentActivity {


  public static void launch(Context context) {
    final Intent intent = new Intent(context, MountActivity.class);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fragment = new MountFragment();
    replaceFragment(fragment);

    LogHelper.enterPage(LogHelper.PAGE_INSTALL);
  }
}
